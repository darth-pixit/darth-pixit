...
export function RootNavigator() {
  ...
  // Hold until Firebase resolves the persisted session. This prevents the login
  // screen (and its auto-focused keyboard) from flashing briefly for users who
  // are already signed in — Firebase typically completes in < 200 ms.
  if (initializing) {
    return (
